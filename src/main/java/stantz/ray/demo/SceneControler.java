...
public class SceneControler implements stantz.ray.SceneControler {
  ...
  public Scene getCurrentScene(int width, int height) {
    ...
    double n = 3;
    double cosn = Math.cos(n * step * 2 * Math.PI / total);
    double sinn = Math.sin(n * step * 2 * Math.PI / total);
//    objects.add(new Sphere(new Vector3D(0*cos,0*sin,100), 25+5*cos, new Color(0.5f+0.5f*(float)cos,0.5f+0.5f*(float)sin,0.2f)));
    objects.add(new Sphere(new Vector3D(0*cos,0*sin,150+50*cosn), 50, new Color(1f, 1f, 1f)));
    ...
    objects.add(new Sphere(new Vector3D(50*cosn,-50*sinn+ 50*cos,100 + 25 * sin), 20, new Color(0.2f,1f,1f)));
    ...
    lightSources.add(new LightSource(new Color(0.3f, 0.3f, 0.3f), new Vector3D(0,1000,1000)));
    lightSources.add(new LightSource(new Color(1f, 1f, 1f), new Vector3D(150*cos,-150*sin,100)));
